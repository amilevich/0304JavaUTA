...
public class UnitTester
{
		...
		public void withdrawSuccess() {
			...
			Account account = new Account(0, Account.AccountType.CHECKING,
					Account.AccountState.PENDING_APPROVAL, 0, c);
		...
		public void withdrawFailNotOpen() {
			...
			{
				assertTrue("Account should not be open", account.getState() == Account.AccountState.TERMINATED);
		...
		public void transferSuccess() {
			...
			Employee e = new Employee(null, null);
			Account account1 = new Account(0, Account.AccountType.CHECKING,
					Account.AccountState.PENDING_APPROVAL, 0, c1);
			Account account2 = new Account(1, Account.AccountType.CHECKING,
					Account.AccountState.PENDING_APPROVAL, 0, c2);
		...
		public void viewAccountSuccess() {
			...
			Account.AccountState testState = (Account.AccountState) account.getAccountInfo()[3];
