...
public class Reimbursement {
	...
	private Blob reimbReceipt; //Byte[]
	...
	public Blob getReimbReceipt() { //Byte[]
		return reimbReceipt;
	}

	public void setReimbReceipt(Blob reimbReceipt) { //Byte[]
	...
	public Reimbursement(Integer reimbId, Double reimbAmount, Timestamp reimbSubmitted, Timestamp reimbResolved,
			String reimbDescription, /*Byte[]*/Blob reimbReceipt, Integer reimbAuthor, Integer reimbResolver,
